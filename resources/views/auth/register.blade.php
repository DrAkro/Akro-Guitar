...
<style>
    ...
    .card {
        border-radius: 15px;
        background-url:('/img/bg3.jpg'); /* Ganti dengan URL gambar */
        ...
        background-repeat: no-repeat; /* Gambar tidak diulang */ /* Transparan agar gambar tetap terlihat */
    }

    .card-header {
        border-radius: 15px 15px 0 0;
        background-color: #gray; /* Header dengan warna gelap */
    }

    .btn-dark {
        background-color: #343a40; /* Warna tombol gelap */
        border-color: #343a40;
    }

    .btn-dark:hover {
        background-color: #23272b; /* Warna tombol saat hover */
        border-color: #23272b;
    }

    .form-control {
        border-radius: 10px;
        border-color: #ccc; /* Border abu-abu terang pada input */
    }
